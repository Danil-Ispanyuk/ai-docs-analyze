...
| RM-5 | Toast notifications (Sonner) | [rm-5-toasts.md](./rm-5-toasts.md) | planned |
| RM-2 | Password reset | [rm-2-password-reset.md](./rm-2-password-reset.md) | planned |
| RM-3 | Billing & plan limits (Stripe test mode) | [rm-3-billing.md](./rm-3-billing.md) | planned |
| RM-4 | Presentation / guest (demo) mode | [rm-4-guest-mode.md](./rm-4-guest-mode.md) | planned |
